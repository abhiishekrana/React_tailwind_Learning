...
const ProductCard = () => {
  ...
  const topRatedProducts = () => {
    ...
    let filteredproduct = listOfProduct.filter(
  ...
  return listOfProduct.length === 0 ? (
    <Skeleton />
      ...
      <div className="mt-10 mx-5 space-x-10">
        <div>
        <input
          className="border border-grey-700 p-2"
          type="text"
          onChange={(e) => setSearchText(e.target.value)}
          value={searchText}
        />
        <button
          className="bg-purple-600 px-6 py-1 rounded-md text-white"
          onClick={() => {
        ...
        <button
          className="bg-purple-600 px-6 py-1 rounded-md text-white mx-20"
          onClick={topRatedProducts}
